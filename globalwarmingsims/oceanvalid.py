...
a = fig1.line('tyears', 'surfacetemp', source=data, line_width=3, alpha=.85, color='black', line_dash='dashed', legend='Transient Climate Response (TCR)')
b = fig1.line('tyears', 'temp', source=data, line_width=3, alpha=.85, color='black', line_dash='dotted', legend='Equivalent Climate Sensitivity (ECS)')
